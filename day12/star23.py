...
def dfs(node_id, end_id, nodes, visited, path, paths):
    node = nodes[node_id]
    ...
    for next in adjacent:
        ...
        paths = dfs(next.id, end_id, nodes, next_visited, next_path, paths)
    return paths
...
paths = dfs('start', 'end', nodes, [nodes['start']], [nodes['start']], [])
